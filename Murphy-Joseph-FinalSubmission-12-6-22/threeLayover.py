...
logging.warn(type(layoverFlightNumber4))
...
layoverTimeHour4 = int(form.getfirst("LayoverTimeHour4", ""))
logging.warn(layoverTimeHour4)
layoverTimeMinute4 = int(form.getfirst("LayoverTimeMinute4", ""))
logging.warn(layoverTimeMinute4)
#layoverTime2 = 14
amPM4 = str(form.getfirst("AMPM4", ""))
logging.warn(amPM4)
if amPM4 == "PM":
	layoverTimeHour4 = layoverTimeHour4 + 12
layoverTimeMinute4 = layoverTimeMinute4 / 60
layoverTime4 = layoverTimeHour4 + layoverTimeMinute4
...
def layoverTimeCost(layoverFlightNumber1, layoverFlightNumber2,layoverFlightNumber3, layoverFlightNumber4, layoverTime1, layoverTime2, layoverTime3, layoverTime4, layoverCost, hourCost):
	...
	delayTime4 = random.uniform(0,4)
	delayCost = delayTime4 * hourCost
	totalTime= layoverTime4 + delayTime4
	totalLayoverTimeCost = delayCost + layoverCost
	delayCost = delayTime4 * hourCost
	totalTime= layoverTime4 + delayTime4
	totalLayoverTimeCost = delayCost + layoverCost

	minutes = delayTime2 % 1
	minutes = minutes * 60

	newLayoverDelayTimeHour = math.floor(delayTime4)
